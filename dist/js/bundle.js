...
function Human(theobject){
  ...
  if(theobject!=undefined){
    if(theobject.cool!=undefined){
      this.cool=theobject.cool;
    } else{
      this.cool=false;
    }
...
function Dog(theobject){
this.status="normal"

if(theobject!=undefined){
  if(theobject.color!=undefined){
    this.color=theobject.color;
  }

  if(theobject.hungry!=undefined){
    this.hungry=theobject.hungry;
  } else{
    this.hungry=true;
  }
